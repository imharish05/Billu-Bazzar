  ...
  return (
    <>
      ...
      <motion.a
        ...
        className="fixed bottom-6 right-6 z-50 p-3 bg-[#25D366] hover:bg-[#20ba5a] text-white shadow-lg hover:shadow-xl transition-all duration-300 rounded-full focus-visible:outline-2 focus-visible:outline-[#25D366] active:scale-95 flex items-center justify-center"
